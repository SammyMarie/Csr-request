...
(function () {
    ...
    function createPKCS10Internal() {
        ...
        pkcs10.subject.typesAndValues.push(new AttributeTypeAndValue({
                                                                         type: "2.5.4.6",
                                                                         value: new PrintableString({ value: "UK" })
                                                                     }));
        pkcs10.subject.typesAndValues.push(new AttributeTypeAndValue({
                                                                         type: "2.5.4.3",
                                                                         value: new Utf8String({ value: "CSR" })
                                                                     }));
    ...
    function parsePKCS10() {
        ...
        if ("attributes" in pkcs10) {
            for (var _i18 = 0; _i18 < pkcs10.attributes.length; _i18++) {
                var _typeval = pkcs10.attributes[_i18].type;
                var _subjval = "";

                for (var j = 0; j < pkcs10.attributes[_i18].values.length; j++) {
                    // noinspection OverlyComplexBooleanExpressionJS
                    if (pkcs10.attributes[_i18].values[j] instanceof Utf8String || pkcs10.attributes[_i18].values[j] instanceof BmpString || pkcs10.attributes[_i18].values[j] instanceof UniversalString || pkcs10.attributes[_i18].values[j] instanceof NumericString || pkcs10.attributes[_i18].values[j] instanceof PrintableString || pkcs10.attributes[_i18].values[j] instanceof TeletexString || pkcs10.attributes[_i18].values[j] instanceof VideotexString || pkcs10.attributes[_i18].values[j] instanceof IA5String || pkcs10.attributes[_i18].values[j] instanceof GraphicString || pkcs10.attributes[_i18].values[j] instanceof VisibleString || pkcs10.attributes[_i18].values[j] instanceof GeneralString || pkcs10.attributes[_i18].values[j] instanceof CharacterString) {
                        _subjval = _subjval + (_subjval.length === 0 ? "" : ";") + pkcs10.attributes[_i18].values[j].valueBlock.value;
                    } else _subjval = _subjval + (_subjval.length === 0 ? "" : ";") + pkcs10.attributes[_i18].values[j].constructor.blockName();
                }
